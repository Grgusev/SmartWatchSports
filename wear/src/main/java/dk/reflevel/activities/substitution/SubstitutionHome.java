...
public class SubstitutionHome extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.substitution_home);
    ...
    public boolean saveArray() {
        SharedPreferences sp = this.getSharedPreferences("sub", Activity.MODE_PRIVATE);
