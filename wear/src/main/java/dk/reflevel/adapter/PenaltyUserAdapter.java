...
public class PenaltyUserAdapter extends RecyclerView.Adapter<PenaltyUserAdapter.MyViewHolder> {
    ...
    public PenaltyUserAdapter(Context context, List<PenaltyUser> PenaltyUsersList) {
