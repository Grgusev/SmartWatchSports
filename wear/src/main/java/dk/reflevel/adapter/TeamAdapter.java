...
public class TeamAdapter extends RecyclerView.Adapter<TeamAdapter.ViewHolder> {
    ...
    public List<PenaltyUser> mItems;
    private Context mContext;

    public TeamAdapter(Context context, List<PenaltyUser> items) {
        mContext = context;
        mItems = items;
    }
    ...
    public TeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View view = inflater.inflate(R.layout.layout_radio, parent, false);
    ...
    public void onBindViewHolder(TeamAdapter.ViewHolder holder, int position) {
        ...
        holder.mText.setText(mItems.get(position).getTitle());
    }
