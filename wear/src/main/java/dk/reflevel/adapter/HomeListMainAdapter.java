...
public class HomeListMainAdapter extends RecyclerView.Adapter<HomeListMainAdapter.MyViewHolder> {
    ...
    public HomeListMainAdapter(Context context, List<CardModel> list) {
